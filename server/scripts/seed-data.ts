...
export async function seedDemoData(credentials: SeedCredentials) {
  ...
  await ArtistProfileModel.updateOne(
    { userId: artist._id },
    {
      $set: {
        ...
        profileImageUrl: "/images/creators/creator-1-720.webp",
        coverImageUrl: "/images/interiors/artist-studio-1200.webp",
        city: "Lahore",
        province: "Punjab",
        country: "Pakistan",
  ...
  await GalleryProfileModel.updateOne(
    { userId: gallery._id },
    {
      $set: {
        ...
        logoUrl: "/images/creators/creator-3-720.webp",
        coverImageUrl: "/images/hero/artdera-hero-1200.webp",
        city: "Karachi",
        province: "Sindh",
        country: "Pakistan",
        verificationStatus: "approved",
  ...
  const artistStore = await StoreModel.findOneAndUpdate(
    { slug: "ayla-raza-studio" },
    {
      $set: {
        ...
        logoUrl: "/images/creators/creator-1-720.webp",
        coverImageUrl: "/images/interiors/artist-studio-1200.webp",
        categories: ["Abstract", "Contemporary"],
        styles: ["Minimal", "Expressionist"],
        mediums: ["Acrylic", "Mixed Media"],
  ...
  const artworkSeeds = [
    [
      ...
      "Minimal",
      145000,
      "/images/artworks/art-1-720.webp",
    ],
    [
      artistStore,
      artist,
      ...
      "Expressionist",
      210000,
      "/images/artworks/art-2-720.webp",
    ],
    [
      artistStore,
      artist,
      ...
      "Modern",
      98000,
      "/images/artworks/art-3-720.webp",
    ],
    [
      galleryStore,
      gallery,
      ...
      "Contemporary",
      76000,
      "/images/artworks/art-4-720.webp",
    ],
    [
      galleryStore,
      gallery,
      ...
      "Traditional",
      125000,
      "/images/artworks/art-5-720.webp",
    ],
    [
      galleryStore,
      gallery,
      ...
      "Minimal",
      260000,
      "/images/artworks/art-6-720.webp",
    ],
  ] as const;
  const artworks = [];
  for (const [
  ...
  await CollectionModel.updateOne(
    { slug: "new-pakistani-abstraction" },
    {
      $set: {
        ...
        coverImageUrl: "/images/artworks/art-1-720.webp",
        isPublished: true,
        sortOrder: 1,
      },
    },
